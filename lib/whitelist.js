...
const log = require("./logging")("whitelist");
const sleep = require("./util/sleep");
const permutateCase = require("./util/permutateCase");
const path = require("path");

const storagePath = path.resolve(
  process.cwd(),
  globalConfig?.whitelist?.storageDir ?? "./whitelist.json"
);
...
class WhitelistManager extends EventEmitter {
  ...
  async refresh() {
    ...
    writer.write(storagePath, [...currentDomains]);
